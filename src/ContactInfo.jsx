    ...
    <Box sx={{ fontWeight: 'bold', marginTop: '75px' }}>
        ...
        <Grid container>
            <List sx={{ width: '100%', maxWidth: 360, fontWeight: 'bold' }}>
                <ListItem>
                    <ListItemText primary={<Typography variant="title" color="info">Heriberto Hernández Torres</Typography>} />
                </ListItem>
                <ListItem>
                    <ListItemText primary={<Typography variant="title" color="info">Desarrollador fullstack</Typography>} />
                </ListItem>
                <ListItem>
                    <ListItemText primary={<Typography variant="h6" color="info">Desde 2018</Typography>} />
                </ListItem>
            </List>
        </Grid >
        <List sx={{ width: '100%', maxWidth: 360, fontWeight: 'bold' }}>
